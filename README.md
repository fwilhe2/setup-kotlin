...
Starting with version [`1.4.30`](https://github.com/JetBrains/kotlin/releases/tag/v1.5.31), you can configure `kotlin` as a shell in Actions like in this example:
